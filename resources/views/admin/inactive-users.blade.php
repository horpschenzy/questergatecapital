                ...
                <main class="p-6 flex-1 bg-gray-200 overflow-y-auto relative">
                    ...
                    <div class="md:flex">
                        <div class="w-full md:w-4/6 ">                            
                            <span class="text-xl md:text-2xl leading-snug font-semibold tracking-tight text-gray-900">In-Active Users</span>
                        </div>

                        <div class="w-full md:w-2/6">
                            <div class="relative">
                                @if(Auth::user()->usertype == 'superadmin')
                                    <a href="{{ url('admin/export/inactive/users') }}"><button type="button" class="text-white px-4 py-2 font-semibold bg-lime-100 border rounded focus:outline-none focus:shadow-outline w-full withdraw-fund"><span>Export In-Active Users</span></button></a>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="bg-white rounded shadow overflow-x-auto mt-6">
                        <table class="w-full whitespace-no-wrap withdrawal-list">
                            ...
                            <tr class="hover:bg-gray-100 focus-within:bg-gray-100 tr-data">
                                ...
                                <td class="border-t">
                                    <a href="{{url('admin/edit/user/'.$u->id)}}"><span tabindex="-1" class="focus:outline-none px-1"><i class="fa-solid fa-user-pen" title="edit user info"></i></span></a>
                                    @if(Auth::user()->usertype == 'superadmin')
                                    <a href="{{url('admin/user/'.$u->id)}}"><span tabindex="-1" class="focus:outline-none px-1"><i class="fa-solid fa-eye" title="view user info"></i></span></a>
                                    <a onclick="deleteConfirm(this);" data-id="{{$u->id}}" data-name="Delete"><span tabindex="-1" class="items-center px-1"><i class="fa-solid fa-delete-left" title="delete user"></i></span></a>
                                    @endif
                                </td>
                            </tr> 
                            @endforeach

        ...
        <div class="h-screen flex">
            ...
            <div class="flex-1 min-w-0 flex flex-col bg-white">
                ...
                <main class="p-6 flex-1 bg-gray-200 overflow-y-auto">
                    <h2 class="text-xl md:text-2xl leading-snug font-semibold tracking-tight text-gray-900">Earning List</h2>
                            ...
                            @foreach($earning as $d)
                                @if($d->amount != 0.00)
                                    <tr class="hover:bg-gray-100 focus-within:bg-gray-100 tr-data">
                                        ...
                                        <td class="border-t">
                                            <span tabindex="-1" class="px-6 py-4 flex items-center focus:outline-none">{{$d->fullname}}</span>
                                        </td>
                                        <td class="border-t">
                                            <span tabindex="-1" class="px-6 py-4 flex items-center focus:outline-none">{{$d->userid}}</span>
                                        </td>
                                        <td class="border-t">
                                            <span tabindex="-1" class="px-6 py-4 flex items-center focus:outline-none">{{$d->date}}</span>
                                        </td>
                                    </tr> 
                                @endif
                            @endforeach

            ...
            <form action="#" method="POST" class="w-full" id="forgotPasswordLink">
              <div>
                <p class="alert-success-alt p-3 rounded text-sm my-2 display-success" style="display: none;">
                    ...
                    <span style="vertical-align: middle;">Password reset link has been sent to the email address provided.</span>
                </p>
              ...
              <div class="mt-8">
                <div aria-required="true" aria-invalid="false">
                  <input id="email" name="email" type="email" placeholder="Email" data-vv-as="email" class="bg-white text w-full focus:outline-none px-3 py-3 rounded text-gray-900 border focus:bg-white mt-3 border-gray-400"> 
              ...
              <div class="mt-6">
                <div>
                  <button type="button" class="focus:outline-none focus:shadow-outline bg-indigo-500 hover:bg-indigo-600 px-4 py-3 text-white w-full md:flex-1 rounded border-b-2 border-indigo-600 font-semibold mt-4 opacity-75" onclick="Plugin.sendResetPasswordLink(this);">

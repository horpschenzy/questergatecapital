...
<html class="bg-gray-200"><head>
    ...
    <title>Admin Users Trash - QuesterGate Limited</title>
    @include('favicon')
    ...
    <body class="font-sans antialiased text-gray-900 leading-normal">
        <div class="h-screen flex">
            ...
            <div class="flex-1 min-w-0 flex flex-col bg-white">
                ...
                <main class="p-6 flex-1 bg-gray-200 overflow-y-auto relative">
                    ...
                    <h2 class="text-xl md:text-2xl leading-snug font-semibold tracking-tight text-gray-900">Users Trash</h2>
                    ...
                    <div class="bg-white rounded shadow overflow-x-auto mt-6">
                        <table class="w-full whitespace-no-wrap withdrawal-list">
                            <tr class="text-left font-semibold">
                                ...
                                <th class="px-6 pt-6 pb-4">Deleted Date</th>
                            ...
                            <tr class="hover:bg-gray-100 focus-within:bg-gray-100 tr-data">
                                ...
                                <td class="border-t">
                                    <span tabindex="-1" class="px-6 py-4 flex items-center focus:outline-none">{{ date('M j, Y', strtotime($u->deleted_at))}}</span>
                                </td>
                                @if(Auth::user()->usertype == 'superadmin')
                                <td class="border-t">
                                    <a onclick="restoreConfirm(this);" data-id="{{$u->id}}" data-name="Restore"><span tabindex="-1" class=items-center">Restore</span></a>
                                </td>
                                @endif
                            </tr> 
                            @endforeach
                            ...
                            <tr class="hover:bg-gray-100 focus-within:bg-gray-100 tr-data">
                                <td class="border-t">
                                    <span  tabindex="-1" class="px-6 py-4 flex items-center focus:outline-none">No Active Users</span>
                                </td>
                            </tr>
                            @endif
                        </table>
        ...
        <!-- restore confirm -->
        <div id="restore-confirm" class="restore-confirm" style="display: none">
                ...
                <div class="relative max-h-full overflow-y-auto w-full md:w-128">
                    <div class="w-full bg-white rounded-lg shadow-2xl px-6 py-6"> 
                        <div class="display-success bg-green-100 p-3" style="display: none;">
                            <span class="text-green-700">&check; User restored successfully.</span>
                        </div>

                        <h4 class="font-semibold text-gray-800 text-lg leading-tight pb-4">
                            <button class="block text-gray-600 hover:text-gray-800 float-right" onclick="closeModal('.restore-confirm');"><svg viewBox="0 0 24 24" fill="currentColor" class="h-4 w-4"><path d="M17.293 18.707a1 1 0 001.414-1.414L13.414 12l5.293-5.293a1 1 0 00-1.414-1.414L12 10.586 6.707 5.293a1 1 0 00-1.414 1.414L10.586 12l-5.293 5.293a1 1 0 101.414 1.414L12 13.414l5.293 5.293z"></path></svg></button>
                        </h4>
                        ...
                        <div class="flex justify-center mt-5">
                            <button type="button" class="bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-white w-2/6 py-2 px-4 border border-red-500 hover:border-transparent rounded" onclick="restoreUser(this);">
                                Restore
                            </button>

                            <button type="button" class="focus:outline-none focus:shadow-outline bg-gray-300 px-4 py-3 rounded border w-2/6 ml-3 font-semibold" onclick="closeModal('.restore-confirm');">
                                Cancel
                            </button>
                        </div>                        
                    </div>

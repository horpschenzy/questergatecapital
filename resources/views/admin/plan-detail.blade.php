                ...
                <div class="flex-1 min-w-0 flex flex-col bg-white">
                    ...
                    <a id="scroll-top-btn"></a>
                        ...
                        <div class="flex justify-between py-5">
                            <div><a href="/admin/investments" class="view-more">&lsaquo;&lsaquo; Back to My Investments</a></div>
                        </div>
            ...
            @else
                <div class="flex-1 min-w-0 flex flex-col bg-white">
                    ...
                    <a id="scroll-top-btn"></a>
                        ...
                        @include('admin.layout.scroll')
                        <div class="flex justify-between py-5">
                            <div><a href="/admin/investments" class="view-more">&lsaquo;&lsaquo; Back to Investments</a></div>
                        </div>
                    ...
                    <div class="relative max-h-full overflow-y-auto w-full md:w-128">
                        <div class="w-full bg-white rounded-lg shadow-2xl px-6 py-6"> 
                            ...
                            <div class="flex justify-center mt-5">
                                <button type="button" class="bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-white w-2/6 py-2 px-4 border border-red-500 hover:border-transparent rounded" onclick="adminDeletePlan(this);">
                                    Delete
                                </button>
                    ...
                    <div class="relative max-h-full overflow-y-auto w-full md:w-128">
                        <div class="w-full bg-white rounded-lg shadow-2xl px-6 py-6"> 
                            ...
                            <div class="flex justify-center mt-10">
                                <button type="button" class="bg-transparent hover:bg-red-500 text-red-700 font-semibold hover:text-white w-2/6 py-2 px-4 border border-red-500 hover:border-transparent rounded" onclick="adminDeactivatePlan(this);">
                                Deactivate
                                </button>

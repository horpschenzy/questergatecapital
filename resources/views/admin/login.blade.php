        ...
        <div class="flex items-center justify-center h-full p-12">
          <div class="mt-6 w-full max-w-sm">
            ...
            <div class="flex items-center justify-between">
              <h2 class="font-semibold text-gray-900 text-lg uppercase leading-tight border-b-2 border-gray-200 pb-4">Admin Sign In</h2>
            </div>
            ...
            <form method="POST" class="w-full login-form">
              ...
              <div class="mt-6">
                <div>
                  <button type="button" class="focus:outline-none focus:shadow-outline bg-indigo-500 hover:bg-indigo-600 px-4 py-3 text-white w-full md:flex-1 rounded border-b-2 border-indigo-600 font-semibold mt-4 opacity-75" onclick="Plugin.loginAdmin(this);">
                    <span>Sign in</span>
                  </button>

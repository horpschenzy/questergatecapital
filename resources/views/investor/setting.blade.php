...
<html class="bg-gray-200"><head>
    ...
    <title> Settings - QuesterGate Capital</title>
    @include('favicon')
        ...
        <div class="h-screen flex">
            ...
            <div class="flex-1 min-w-0 flex flex-col bg-white">
                ...
                <a id="scroll-top-btn"></a>
                    <h2 class="text-xl md:text-2xl leading-snug font-semibold tracking-tight text-gray-900">Settings</h2> 
                    ...
                    <div class="py-5 border-b border-gray-300 mt-10">
                        <div class="flex flex-col xl:flex-row">
                            <div class="w-full xl:w-1/3">
                                ...
                                <p class="mt-2 text-gray-500">Manage your account personal profile</p>
                            </div> 
                                ...
                                <div class="bg-white rounded-md shadow overflow-hidden p-5 sm:max-w-lg md:max-w-3xl">
                                    <form method="POST" class="basic-profile-form">
                                        ...
                                        <div class="flex flex-wrap -mx-3">
                                            ...
                                            <div class="w-full md:w-1/2 px-3">
                                                <div aria-required="false" aria-invalid="false">
                                                    ...
                                                    <input name="phone" type="number" class="bg-white text w-full focus:outline-none px-3 py-3 rounded text-gray-900 border focus:bg-white mt-2 border-gray-400" value="{{$phone[0]->phone}}"> 
                                                    <p class="text-red-500 text-xs italic my-2" style="display: none;"></p>
                                                </div>
                                            </div> 
                                        ...
                                        <div class="w-full sm:w-56">
                                            <button type="button" class="focus:outline-none focus:shadow-outline w-full md:flex-1 bg-lime-100 hover:bg-lime-100 px-4 py-3 text-white rounded border-b-2  font-semibold mt-4" onclick="updateProfile(this);"><span>Update Profile</span></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                    ...
                    <div class="py-5 border-b border-gray-300 mt-10">
                        <div class="flex flex-col xl:flex-row">
                            <div class="w-full xl:w-1/3">
                                ...
                                <p class="mt-2 text-gray-500">Manage your next of kin's information</p>
                            </div> 
                                ...
                                <div class="bg-white rounded-md shadow overflow-hidden p-5 sm:max-w-lg md:max-w-3xl">
                                    <form  method="POST" class="contact-form">
                                        ...
                                        <div class="flex flex-wrap -mx-3"> 
                                            ...
                                            <div class="w-full md:w-1/2 px-3"><div aria-required="true" aria-invalid="false"><label class="text-gray-700 block mt-2">Next of kin</label> <input name="nok_name" type="text" class="bg-white text w-full focus:outline-none px-3 py-3 rounded text-gray-900 border focus:bg-white mt-2 border-gray-400" value="{{sizeof($nok) ? $nok[0]->nok_name : ''}}"> <p class="text-red-500 text-xs italic my-2" style="display: none;"></p> <!----></div></div>

                                            <div class="w-full md:w-1/2 px-3"><div aria-required="true" aria-invalid="false"><label class="text-gray-700 block mt-2">Next of kin's Phone</label> <input name="nok_phone" type="number" class="bg-white text w-full focus:outline-none px-3 py-3 rounded text-gray-900 border focus:bg-white mt-2 border-gray-400" value="{{sizeof($nok) ? $nok[0]->nok_phone : ''}}"> <p class="text-red-500 text-xs italic my-2" style="display: none;"></p> <!----></div></div> 

                                            <div class="w-full md:w-1/2 px-3"><div aria-required="true" aria-invalid="false"><label for="next_of_kin_relationship" class="text-gray-700 block mt-2">Next of kin's Relationship</label> <input name="nok_relationship" type="text" class="bg-white text w-full focus:outline-none px-3 py-3 rounded text-gray-900 border focus:bg-white mt-2 border-gray-400" value="{{sizeof($nok) ? $nok[0]->nok_relationship : ''}}"> <p class="text-red-500 text-xs italic my-2" style="display: none;"></p> <!----></div></div> 

                                            <div class="w-full md:w-1/2 px-3"><div aria-required="true" aria-invalid="false"><label for="next_of_kin_state" class="text-gray-700 block mt-2">Next of kin's State</label> <div class="relative"><input name="nok_state" type="text" class="bg-white text w-full focus:outline-none px-3 py-3 rounded text-gray-900 border focus:bg-white mt-2 border-gray-400" value="{{sizeof($nok) ? $nok[0]->nok_state : ''}}"> <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700"></div></div> <p class="text-red-500 text-xs italic my-2" style="display: none;"></p> <!----></div></div> 

                                            <div class="w-full md:w-1/2 px-3"><div aria-required="true" aria-invalid="false"><label class="text-gray-700 block mt-2">Next of kin's City</label> <div class="relative"><input name="nok_city" type="text" placeholder="123 Street name" class="bg-white text w-full focus:outline-none px-3 py-3 rounded text-gray-900 border focus:bg-white mt-2 border-gray-400" value="{{sizeof($nok) ? $nok[0]->nok_city : ''}}"> <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2 text-gray-700"></div></div> <p class="text-red-500 text-xs italic my-2" style="display: none;"></p> <!----></div></div> 

                                            <div class="w-full md:w-1/2 px-3"><div aria-required="true" aria-invalid="false"><label class="text-gray-700 block mt-2">Next of kin's Address</label> <input name="nok_address" type="text" placeholder="123 Street name" class="bg-white text w-full focus:outline-none px-3 py-3 rounded text-gray-900 border focus:bg-white mt-2 border-gray-400" value="{{sizeof($nok) ? $nok[0]->nok_address : ''}}"> <p class="text-red-500 text-xs italic my-2" style="display: none;"></p> <!----></div></div></div> 

                                            <div class="w-full sm:w-56"><button type="button" class="focus:outline-none focus:shadow-outline w-full md:flex-1 bg-lime-100 hover:bg-lime-100 px-4 py-3 text-white rounded border-b-2  font-semibold mt-4" onclick="updateNOK(this);"><span>Update Next Of Kin</span></button></div>
                                    </form>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="py-5 border-b border-gray-300 mt-10">
                        <div class="flex flex-col xl:flex-row">
                            <div class="w-full xl:w-1/3">
                                ...
                                <p class="mt-2 text-gray-500">Manage your account password or set a new password</p>
                            </div> 
                            <div class="w-full xl:w-2/3 pl-0 xl:pl-5 mt-4 xl:mt-0">
                                <div class="bg-white rounded-md shadow overflow-hidden p-5 sm:max-w-lg md:max-w-3xl">
                                    <form method="POST" class="security-form">
                                        ...
                                        <div class="w-full sm:w-56">
                                            <button type="button" class="focus:outline-none focus:shadow-outline w-full md:flex-1 bg-lime-100 hover:bg-lime-100 px-4 py-3 text-white rounded border-b-2  font-semibold mt-4" onclick="changePassword(this);"><span>Update Password</span>
                                            </button>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <div class="py-5 border-gray-300 mt-10">
                        <div class="flex flex-col xl:flex-row">
                            <div class="w-full xl:w-1/3">
                                ...
                                <p class="mt-2 text-gray-500">Manage your bank account details</p>
                            </div> 
                                        ...
                                        <div class="flex flex-wrap -mx-3">
                                            <div class="w-full md:w-1/2 px-3">
                                                <div class="relative">
                                                    ...
                                                    <select name="bank" class="block appearance-none w-full focus:outline-none px-3 py-3 rounded text-gray-900 border focus:bg-white bg-white mt-2 border-gray-400">
                                                        @if(sizeof($bank))
                                                        <option value="{{$bank[0]->bank}}">{{$bank[0]->bank}}</option>
                                                        @endif
                                            ...
                                            <div class="w-full md:w-1/2 px-3">
                                                <div aria-required="false" aria-invalid="false">
                                                    ...
                                                    <input name="account_name" type="text" class="bg-white text w-full focus:outline-none px-3 py-3 rounded text-gray-900 border focus:bg-white mt-2 border-gray-400" value="{{sizeof($bank) ? $bank[0]->account_name : ''}}"> 
                                                    <p class="text-red-500 text-xs italic my-2" style="display: none;"></p> <!---->
                                                </div>
                                            </div> 
                                            ...
                                            <div class="w-full md:w-1/2 px-3">
                                                <div aria-required="true" aria-invalid="false">
                                                    ...
                                                    <input name="account_number" type="text" class="bg-white text w-full focus:outline-none px-3 py-3 rounded text-gray-900 border focus:bg-white mt-2 border-gray-400" value="{{sizeof($bank) ? $bank[0]->account_number : ''}}"> <p class="text-red-500 text-xs italic my-2" style="display: none;"></p> <!---->
                                                </div>
                                            </div>
                                        </div> 

                                        <div class="w-full sm:w-56">
                                            <button type="button" class="focus:outline-none focus:shadow-outline w-full md:flex-1 bg-lime-100 hover:bg-lime-100 px-4 py-3 text-white rounded border-b-2  font-semibold mt-4" onclick="updateBankAccount(this);"><span>Update Bank Account</span>
                                            </button>
                                        </div>
                                    </form>
                                </div>
